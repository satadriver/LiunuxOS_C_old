...
typedef struct  i825xx_rx_desc_s 
{
...
typedef struct i825xx_tx_desc_s 
{
	volatile uint64_t	address;
...
net_device_t g_net;
i825xx_device_t* g_dev = & g_net.lldev;
...
static void net_i825xx_rx_enable(  )
{
	i825xx_device_t *dev = (i825xx_device_t *)g_dev;
	mmio_write32( i825xx_REG_RCTL, mmio_read32(i825xx_REG_RCTL) | (RCTL_EN) );
}

static int net_i825xx_rx_init( )
{
	int i;
	i825xx_device_t *dev = (i825xx_device_t *)g_dev;
...
static void net_i825xx_tx_poll( void *pkt, uint16_t length )
{
	i825xx_device_t *dev = (i825xx_device_t *)g_dev;
...
static void net_i825xx_rx_poll(  )
{
	i825xx_device_t *dev = (i825xx_device_t *)g_dev;
...
{
	net_device_t *netdev = (net_device_t *)__kMalloc(sizeof(net_device_t));
